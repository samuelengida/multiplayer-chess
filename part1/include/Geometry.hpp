...
public:
	...
	void Gen(std::vector<float>& bufferData, std::vector<unsigned int>& indices);
	void Gen();
	// generat tangent and bitangents.
	void generateTangent(unsigned int vert0, unsigned int vert1, unsigned int vert2);
